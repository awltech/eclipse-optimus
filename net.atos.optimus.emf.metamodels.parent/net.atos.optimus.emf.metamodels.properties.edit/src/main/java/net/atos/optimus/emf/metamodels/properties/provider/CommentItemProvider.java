...
/**
 * This is the item provider adapter for a {@link net.atos.optimus.emf.metamodels.properties.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PropertiesPackage.Literals.COMMENT__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Comment)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Comment.class)) {
			case PropertiesPackage.COMMENT__VALUE:
