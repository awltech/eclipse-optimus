 ...
 * <ul>
 *   <li>{@link net.atos.optimus.emf.metamodels.properties.impl.PropertiesImpl#getContents <em>Contents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropertiesImpl extends EObjectImpl implements Properties {
	...
	public EList<Content> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentWithInverseEList<Content>(Content.class, this, PropertiesPackage.PROPERTIES__CONTENTS, PropertiesPackage.CONTENT__PROPERTIES);
		}
		return contents;
	}
