...
/**
 * Exclusive transformation mask linked with an XML file
 * 
 * @author tnachtergaele <nachtergaele.thomas@gmail.com>
 * 
 *
 */
public class ExclusiveXMLTransformationMask extends XMLTransformationMask {
	 ...
	 *            transformation mask.
	 */
	public ExclusiveXMLTransformationMask(File transformationMaskFilename,
	...
	protected Set<String> getRequirementsTransformation(TransformationReference reference) {
		return MaskTransformationRequirementsTool.requirementsToDesactivate(this, reference);
	}
