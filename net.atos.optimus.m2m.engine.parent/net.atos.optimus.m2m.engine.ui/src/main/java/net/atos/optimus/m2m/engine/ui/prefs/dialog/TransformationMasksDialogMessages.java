...
public enum TransformationMasksDialogMessages {
	...
	CREATION_TITLE, CREATION_MESSAGE, CREATION_DESCRIPTION, EXTENSION_MESSAGE, NAME_CONFLICT, RENAME_TITLE, RENAME_OLD_NAME, RENAME_NEW_NAME, DELETION_TITLE, DELETION_MESSAGE, PREFERRED_MASK_WARNING;
