...
public enum TransformationMasksPreferencesMessages {
	...
	IMPORT_BUTTON, IMPORT_WINDOW, EXPORT_BUTTON, EXPORT_WINDOW, PREFERRED_MASK_LABEL, TRANSFORMATION_MASKS_LABEL, NON_EDITABLE_MASK, DELETE_BUTTON, RENAME_BUTTON, CREATION_BUTTON, MASK_DESCRIPTION, TRANSFORMATIONS_LABEL;
