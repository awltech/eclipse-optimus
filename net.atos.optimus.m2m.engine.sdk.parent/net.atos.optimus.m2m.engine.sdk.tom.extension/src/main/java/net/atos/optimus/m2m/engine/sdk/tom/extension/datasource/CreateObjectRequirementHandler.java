...
/**
 * An handler creating object requirement
 * 
...
public class CreateObjectRequirementHandler extends CreateAbstractRequirementHandler {
	...
	public AbstractRequirement createAbstractRequirement(TransformationReference transformationReference,
		...
		if (!(requirement instanceof SelfRequirement)) {
			return null;
		}
		AbstractRequirement abstractRequirement = new ObjectRequirement();
		DependencyDiagramMessages.EP13.log(transformationReference.getId(), requirement.getReference().getName());
