 ...
 * @generated
 */
public class ParentRequirementLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				TransformationDependencyVisualIDRegistry
						.getType(net.atos.optimus.m2m.engine.sdk.tom.diagram.edit.parts.ParentRequirementLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ParentRequirementLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ParentRequirementLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ParentRequirementLabelFigure extends WrappingLabel {
