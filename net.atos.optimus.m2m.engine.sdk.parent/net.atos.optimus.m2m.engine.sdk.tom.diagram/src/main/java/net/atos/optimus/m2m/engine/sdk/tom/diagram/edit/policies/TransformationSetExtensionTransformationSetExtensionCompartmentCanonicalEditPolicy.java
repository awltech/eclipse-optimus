 ...
 * @generated
 */
public class TransformationSetExtensionTransformationSetExtensionCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return TomPackage.eINSTANCE.getTransformationSetExtension_Transformations();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<TransformationDependencyNodeDescriptor> childDescriptors = TransformationDependencyDiagramUpdater
				.getTransformationSetExtensionTransformationSetExtensionCompartment_7004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Transformation2EditPart.VISUAL_ID == TransformationDependencyVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<TransformationDependencyNodeDescriptor> childDescriptors = TransformationDependencyDiagramUpdater
				.getTransformationSetExtensionTransformationSetExtensionCompartment_7004SemanticChildren((View) getHost()
						.getModel());
