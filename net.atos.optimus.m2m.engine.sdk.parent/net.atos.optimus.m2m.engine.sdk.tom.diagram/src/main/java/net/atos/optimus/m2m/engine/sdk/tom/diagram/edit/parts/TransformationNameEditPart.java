 ...
 * @generated
 */
public class TransformationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TransformationNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TransformationDependencyParserProvider
					.getParser(
							TransformationDependencyElementTypes.Transformation_3003,
							getParserElement(),
							TransformationDependencyVisualIDRegistry
									.getType(net.atos.optimus.m2m.engine.sdk.tom.diagram.edit.parts.TransformationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
