 ...
 * @generated
 */
public class CustomRequirementLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				TransformationDependencyVisualIDRegistry
						.getType(net.atos.optimus.m2m.engine.sdk.tom.diagram.edit.parts.CustomRequirementLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public CustomRequirementLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new CustomRequirementLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CustomRequirementLabelFigure extends WrappingLabel {
