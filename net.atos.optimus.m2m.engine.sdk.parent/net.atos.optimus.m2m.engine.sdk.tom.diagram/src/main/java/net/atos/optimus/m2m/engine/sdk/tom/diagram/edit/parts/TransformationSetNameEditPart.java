 ...
 * @generated
 */
public class TransformationSetNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TransformationSetNameEditPart(View view) {
		super(view);
	}
			...
			parser = TransformationDependencyParserProvider
					.getParser(
							...
							TransformationDependencyVisualIDRegistry
									.getType(net.atos.optimus.m2m.engine.sdk.tom.diagram.edit.parts.TransformationSetNameEditPart.VISUAL_ID));
		}
		return parser;
	}
