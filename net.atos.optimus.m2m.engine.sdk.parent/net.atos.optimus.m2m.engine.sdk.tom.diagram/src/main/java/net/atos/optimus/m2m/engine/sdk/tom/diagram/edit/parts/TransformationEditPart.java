...
import net.atos.optimus.m2m.engine.sdk.tom.diagram.edit.policies.TransformationItemSemanticEditPolicy;
...
public class TransformationEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TransformationItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TransformationNameEditPart) {
			((TransformationNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureTransformationNameFigure());
			return true;
		}
		return false;
	}
