...
import net.atos.optimus.m2m.engine.sdk.tom.diagram.part.TransformationDependencyDiagramEditor;
 ...
 * @generated
 */
public class TransformationDependencyNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof TransformationDependencyNavigatorItem) {
					selectedElement = ((TransformationDependencyNavigatorItem) selectedElement).getView();
				} else if (selectedElement instanceof IAdaptable) {
					selectedElement = ((IAdaptable) selectedElement).getAdapter(View.class);
				}
				if (selectedElement instanceof Diagram) {
					Diagram diagram = (Diagram) selectedElement;
					if (TransformationSetsEditPart.MODEL_ID.equals(TransformationDependencyVisualIDRegistry
							.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, TransformationDependencyDiagramEditor.ID);
