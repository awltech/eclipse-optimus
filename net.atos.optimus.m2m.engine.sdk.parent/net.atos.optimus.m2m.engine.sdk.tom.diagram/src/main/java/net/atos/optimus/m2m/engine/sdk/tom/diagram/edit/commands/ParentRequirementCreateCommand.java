 ...
 * @generated
 */
public class ParentRequirementCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ParentRequirementCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return TransformationDependencyBaseItemSemanticEditPolicy.getLinkConstraints().canCreateParentRequirement_4005(
				getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ParentRequirement newElement = TomFactory.eINSTANCE.createParentRequirement();
	 ...
	 * @generated
	 */
	protected void doConfigure(ParentRequirement newElement, IProgressMonitor monitor, IAdaptable info)
