 ...
 * @generated
 */
public class SelfRequirementReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof SelfRequirement) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TransformationDependencyBaseItemSemanticEditPolicy.getLinkConstraints().canExistSelfRequirement_4004(
	 ...
	 * @generated
	 */
	protected SelfRequirement getLink() {
		return (SelfRequirement) getElementToEdit();
	}
