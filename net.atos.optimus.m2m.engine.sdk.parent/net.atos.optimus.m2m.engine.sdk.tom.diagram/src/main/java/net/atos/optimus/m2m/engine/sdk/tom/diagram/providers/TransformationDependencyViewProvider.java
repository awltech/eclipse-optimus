 ...
 * @generated
 */
public class TransformationDependencyViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return TransformationSetsEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& TransformationDependencyVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = TransformationDependencyVisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = TransformationDependencyVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!TransformationDependencyElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != TransformationDependencyVisualIDRegistry.getNodeVisualID(op.getContainerView(),
								domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!TransformationSetsEditPart.MODEL_ID.equals(TransformationDependencyVisualIDRegistry.getModelID(op
						.getContainerView()))) {
				...
				case Transformation2EditPart.VISUAL_ID:
					if (domainElement == null
							|| visualID != TransformationDependencyVisualIDRegistry.getNodeVisualID(
		...
		return TransformationSetEditPart.VISUAL_ID == visualID
				|| TransformationSetExtensionEditPart.VISUAL_ID == visualID
				|| ExternalTransformationEditPart.VISUAL_ID == visualID || TransformationEditPart.VISUAL_ID == visualID
				|| Transformation2EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = TransformationDependencyVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != TransformationDependencyVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(TransformationSetsEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (TransformationDependencyVisualIDRegistry.getVisualID(elementTypeHint)) {
		case SelfRequirementEditPart.VISUAL_ID:
			return createSelfRequirement_4004(getSemanticElement(semanticAdapter), containerView, index, persisted,
					preferencesHint);
		case ParentRequirementEditPart.VISUAL_ID:
			return createParentRequirement_4005(getSemanticElement(semanticAdapter), containerView, index, persisted,
					preferencesHint);
		case CustomRequirementEditPart.VISUAL_ID:
			return createCustomRequirement_4006(getSemanticElement(semanticAdapter), containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createTransformationSetExtension_2005(EObject domainElement, View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TransformationDependencyVisualIDRegistry.getType(TransformationSetExtensionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createTransformation_3003(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TransformationDependencyVisualIDRegistry.getType(TransformationEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		...
		Node label5006 = createLabel(node,
				TransformationDependencyVisualIDRegistry.getType(TransformationNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createTransformation_3004(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TransformationDependencyVisualIDRegistry.getType(Transformation2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	private void stampShortcut(View containerView, Node target) {
		if (!TransformationSetsEditPart.MODEL_ID.equals(TransformationDependencyVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put("modelID", TransformationSetsEditPart.MODEL_ID); //$NON-NLS-1$
