...
import net.atos.optimus.m2m.engine.sdk.tom.diagram.edit.policies.Transformation2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Transformation2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Transformation2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Transformation2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TransformationName2EditPart) {
			((TransformationName2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(TransformationDependencyVisualIDRegistry
				.getType(TransformationName2EditPart.VISUAL_ID));
	}
