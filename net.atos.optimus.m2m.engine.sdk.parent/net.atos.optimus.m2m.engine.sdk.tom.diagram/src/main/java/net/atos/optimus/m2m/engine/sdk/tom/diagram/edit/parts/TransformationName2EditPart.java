 ...
 * @generated
 */
public class TransformationName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TransformationName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TransformationDependencyParserProvider
					.getParser(
							TransformationDependencyElementTypes.Transformation_3004,
							getParserElement(),
							TransformationDependencyVisualIDRegistry
									.getType(net.atos.optimus.m2m.engine.sdk.tom.diagram.edit.parts.TransformationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
