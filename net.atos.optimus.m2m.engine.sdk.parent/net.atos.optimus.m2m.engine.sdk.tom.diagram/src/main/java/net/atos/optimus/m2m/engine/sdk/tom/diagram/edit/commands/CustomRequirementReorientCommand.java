 ...
 * @generated
 */
public class CustomRequirementReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CustomRequirementReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof CustomRequirement) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return TransformationDependencyBaseItemSemanticEditPolicy.getLinkConstraints().canExistCustomRequirement_4006(
	 ...
	 * @generated
	 */
	protected CustomRequirement getLink() {
		return (CustomRequirement) getElementToEdit();
	}
