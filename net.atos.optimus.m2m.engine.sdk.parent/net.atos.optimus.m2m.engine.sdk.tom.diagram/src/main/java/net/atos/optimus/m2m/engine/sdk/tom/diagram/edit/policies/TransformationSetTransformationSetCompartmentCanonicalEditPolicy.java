 ...
 * @generated
 */
public class TransformationSetTransformationSetCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return TomPackage.eINSTANCE.getTransformationSet_Transformations();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<TransformationDependencyNodeDescriptor> childDescriptors = TransformationDependencyDiagramUpdater
				.getTransformationSetTransformationSetCompartment_7003SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return TransformationEditPart.VISUAL_ID == TransformationDependencyVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<TransformationDependencyNodeDescriptor> childDescriptors = TransformationDependencyDiagramUpdater
				.getTransformationSetTransformationSetCompartment_7003SemanticChildren((View) getHost().getModel());
