 ...
 * @generated
 */
public class CustomRequirementCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CustomRequirementCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return TransformationDependencyBaseItemSemanticEditPolicy.getLinkConstraints().canCreateCustomRequirement_4006(
				getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		CustomRequirement newElement = TomFactory.eINSTANCE.createCustomRequirement();
	 ...
	 * @generated
	 */
	protected void doConfigure(CustomRequirement newElement, IProgressMonitor monitor, IAdaptable info)
