 ...
 * @generated
 */
public class SelfRequirementLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				TransformationDependencyVisualIDRegistry
						.getType(net.atos.optimus.m2m.engine.sdk.tom.diagram.edit.parts.SelfRequirementLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public SelfRequirementLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new SelfRequirementLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SelfRequirementLabelFigure extends WrappingLabel {
