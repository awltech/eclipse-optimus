...
import net.atos.optimus.m2m.engine.sdk.tom.diagram.edit.policies.TransformationDependencyTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TransformationSetExtensionTransformationSetIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TransformationSetExtensionTransformationSetIdEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new TransformationDependencyTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return TransformationDependencyElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TransformationDependencyParserProvider
					.getParser(
							TransformationDependencyElementTypes.TransformationSetExtension_2005,
							getParserElement(),
							TransformationDependencyVisualIDRegistry
									.getType(net.atos.optimus.m2m.engine.sdk.tom.diagram.edit.parts.TransformationSetExtensionTransformationSetIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					TransformationDependencyEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
