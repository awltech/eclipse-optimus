package net.atos.optimus.m2m.engine.sdk.tom.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(TransformationDependencyDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE,
