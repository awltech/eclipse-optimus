...
/**
 * Models the base filter for extension transformation
 * 
 * @author tnachtergaele <nachtergaele.thomas@gmail.com>
 *
 */

public class ExternalTransformationBasePropertyFilter extends AbstractFilter {

	@Override
	public boolean select(Object toTest) {
		EObject eObjectToTest = this.convertToEMF(toTest);
		return eObjectToTest != null
				&& eObjectToTest.eClass() == TomPackage.eINSTANCE.getExternalTransformation();
	}
