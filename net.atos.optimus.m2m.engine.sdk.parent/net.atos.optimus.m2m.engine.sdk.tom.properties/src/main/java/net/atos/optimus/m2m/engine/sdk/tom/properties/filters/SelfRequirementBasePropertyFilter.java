...
/**
 * Models the base filter for self requirement
 * 
 * @author tnachtergaele <nachtergaele.thomas@gmail.com>
 *
 */

public class SelfRequirementBasePropertyFilter extends AbstractFilter {

	@Override
	public boolean select(Object toTest) {
		EObject eObjectToTest = this.convertToEMF(toTest);
		return eObjectToTest != null
				&& eObjectToTest.eClass() == TomPackage.eINSTANCE.getSelfRequirement();
	}
