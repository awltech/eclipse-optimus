...
/**
 * Create a processor resource finding transformation set name resource
 * 
 * @author tnachtergaele <nachtergaele.thomas@gmail.com>
 *
 */

public class TransformationSetResourceProcessor extends ResourceProcessor {
	 ...
	 */
	public TransformationSetResourceProcessor(IProject project, String pattern) {
		super();
	...
	protected void process() {
		...
		for (TransformationDataSource transformationDataSource : TransformationDataSourceManager.INSTANCE
			...
			for(TransformationReference transformationReference : transformationDataSource.getAll()){
				if (Pattern.matches(transformationPattern, transformationReference.getTransformationSet().getId())) {
					transformationSetNames.add(transformationReference.getTransformationSet().getId());
				}
			}
		}
