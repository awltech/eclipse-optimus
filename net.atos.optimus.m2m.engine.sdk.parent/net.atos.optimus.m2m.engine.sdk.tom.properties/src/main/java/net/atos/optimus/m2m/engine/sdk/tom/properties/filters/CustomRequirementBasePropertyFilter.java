...
/**
 * Models the base filter for custom requirement
 * 
 * @author tnachtergaele <nachtergaele.thomas@gmail.com>
 *
 */

public class CustomRequirementBasePropertyFilter extends AbstractFilter {

	@Override
	public boolean select(Object toTest) {
		EObject eObjectToTest = this.convertToEMF(toTest);
		return eObjectToTest != null
				&& eObjectToTest.eClass() == TomPackage.eINSTANCE.getCustomRequirement();
	}
